...
export const MainIntroduction = () => {
  return (
    <GeneralContainer>
      ...
      <TextContainer>
        <h1 className="text-very-d-violet text-4xl md:leading-[1.1] md:text-5xl lg:leading-[1.2] lg:text-6xl font-bold">More than just shorter links</h1>
        <p className="text-grayish-violet max-w-md">Build your brand's recognition and get detailed insights on how your links are performing.</p>

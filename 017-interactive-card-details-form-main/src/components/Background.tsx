...
export const Background = () => {
  return (
    <div className="relative main-bg pt-4 xl:mr-[176px]">
        {/* <source media="(min-width:768px)" srcSet="./images/bg-main-desktop.png"></source>
        <img className="w-full h-[240px] md:min-h-screen md:h-full" src="./images/bg-main-mobile.png" alt="app background" /> */}
